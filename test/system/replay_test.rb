...
class ReplaySystemTest < ApplicationSystemTestCase
  ...
  test "a finished match is replayed with the four controls" do
    ...
    assert_equal "Square 11, empty, moved from here", piece_on(11)
    assert_equal "Square 15, Red man, moved here", piece_on(15)
    ...
    assert_equal "Square 18, White man, moved here", piece_on(18)
    ...
    assert_equal "Square 22, Red man, moved here", piece_on(22)
